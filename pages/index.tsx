...
export default function Home() {
  return (
    <React.Fragment>
      <Swiper
        ...
        <SwiperSlide>
          <div className={`${styles["slide-container"]} p-20 md:p-24`}>
            ...
            <Link href="/project"> <button className="bg-[#1087d2] text-white bannerbutton">
        ...
        <SwiperSlide>
          <div className={`${styles["slide-container"]} p-20`}>
            ...
            <div className={`${styles["controls"]} pt-8`}>
            <button className="bg-[#1087d2] text-white bannerbutton">
      ...
      <div
        className={`${styles["middle-container"]} pl-16 pt-16 pb-16 mt-5 mb-12`}>
        ...
        <div
          ...
          <div className={`${styles["grid"]}`}>
            ...
            <div className={`${styles["card"]} pl-1 md:pl-0`}>
              <h2 className="w-full text-4xl md:w-3/4">
                03
                <br />
                Decades{" "}
              </h2>
              <p className="w-full text-lg md:w-3/4 text-extrabold">
                Of trusted & reliable delivery
              </p>
            </div>
          </div>
          ...
          <div>
            <button className="bg-[#30abb7] text-white p-2 font-semibold dropshadow">
            <Link href="/about-us">   MORE ABOUT US <span className="ml-4"> →</span></Link>
            </button>
          </div>
        </div>
      </div>
      <div className={`${styles["bottom-container"]} p-8 md:p-16`}>
        <div className="flex flex-col gap-4">
          <h1 className="text-4xl not-italic font-semibold text-left text-white">
        ...
        <div className="flex mt-4 font-semibold">
          <button className="bg-[#FFFFFF] text-[#30abb7] font-semibold p-4 csrmenu">
