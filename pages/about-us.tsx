...
<div className="flex flex-wrap p-20 md:p-20">
  ...
  <div className="w-4/5 flex-auto pl-20 border-l-2">
    <div className="w-full">
      <p className="text-sm font-normal leading-loose">Since its inception, Global Tech Park (GTP) has consistently proven to be a venture of bold 
...
</p><p className="text-sm font-normal leading-loose pt-2">We are known for taking risks whilst creating an encouraging environment for professionals alike. Today we operate in multiple countries including UK/USA/Switzerland/Netherlands/Singapore among others; driving 
