...
<div className="flex flex-wrap p-20 md:p-20">
  <div className="w-1/5 flex-auto">
    <div className="w-full"><h1 className="text-4xl font-bold primary-color">Who</h1> <h1 className="text-4xl font-bold primary-color">We are</h1> </div>
  </div>
  <div className="w-4/5 flex-auto pl-20 border-l-2">
    <div className="w-full">
      <p className="text-[16px] leading-loose opacity-50">Since its inception, Global Tech Park (GTP) has consistently proven to be a venture of bold 
...
</p><p className="text-[16px] font-normal leading-loose pt-2 opacity-50">We are known for taking risks whilst creating an encouraging environment for professionals alike. Today we operate in multiple countries including UK/USA/Switzerland/Netherlands/Singapore among others; driving 
...
<div className="flex flex-wrap px-20 pt-4">
  ...
  <div className="w-[30%] flex-auto pr-4">
    <div className="w-full"><h1 className="mb-3 text-2xl font-semibold">Sathish Chandra</h1><Image
...
<div className="flex flex-wrap px-20 pt-4">
  ...
  <div className="w-[30%] flex-auto pr-4">
    <div className="w-full"><h1 className="mb-3 text-2xl font-semibold">Chetan Chandra</h1>
    <Image
...
<div className="flex flex-wrap px-20 pt-6 md:pt-10">
  ...
  <div className="w-[30%] flex-auto pr-4">
    <div className="w-full"><h1 className="mb-3 text-2xl font-semibold">Bindu Chandra</h1> 
   <Image
  ...
  <div className="w-6/12 flex-auto pl-10 pt-5">
    <div className="w-full"><p className=" text-[16px] font-normal leading-loose mt-3 opacity-50">Satish P Chandra is the inspirational Chairman and Managing Director of Global Tech Park, a rapidly expanding provider of infrastructure solutions in India. He was instrumental in creating Bengaluru&#39; s iconic commercial site Think Campus in Electronic City - fondly known as the Dome.
